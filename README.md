...
1. Ensure that you have Python 3.10+ installed (Windows users can grab it from https://www.python.org/downloads/, macOS users can use the same site or run `brew install python@3`)
...
5. In the backend folder, create a ".env" file that sets "SUPABASE_URL" and "SUPABASE_KEY"
