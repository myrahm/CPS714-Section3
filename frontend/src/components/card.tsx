...
export const Card: React.FC<CardProps> = ({
  ...
  return (
    <div className="card shadow-sm rounded-4 p-3 m-5" style={{width: "25%", minWidth: "250px"}}>
      ...
      <section className="d-flex justify-content-between align-items-center flex-wrap mb-2">
          ...
          <p className= "bg-secondary text-white px-1 mb-2" style={{fontSize: "10px"}}>{difficulty}</p>
      </section>

      {/* Trainier and Class Decription Section */}
      <section>
        <hr className="mt-1 mb-1"/>
        <span className="d-flex justify-content-center align-items-center flex-wrap" style={{ fontSize: "14px" }}>
      ...
      <section className="mt-2 mb-2">
        <p className="mb-0" style={{fontSize: "13px"}}><b>Trainer:</b> {trainer}</p>
        <p style={{fontSize: "13px"}}><b>Details:</b> Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
      </section>
